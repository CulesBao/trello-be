...
router.post('/', authenticationMiddleware.authenticateToken(), authenticationMiddleware.authorizePermissionBoard(Permissions.ADD_ATTACHMENT_TO_CARD), attachmentMiddleware.upload, attachmentController.upload)
router.route('/:id')
