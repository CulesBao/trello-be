...
router.post('/', authenticationMiddleware.authenticateToken(), attachmentMiddleware.upload, authenticationMiddleware.authorizePermissionCard(Permissions.ADD_ATTACHMENT_TO_CARD),  attachmentController.upload)
router.route('/:id')
